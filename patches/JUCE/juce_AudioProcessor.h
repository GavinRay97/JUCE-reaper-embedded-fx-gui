...
// TODO: Make opaque types so that this compiles when also generating IE an .au plugin
// And then have the implementation typecast from opaque typedef to specific type w/ #include
...
public:
    ...
    virtual void handleVST3HostContext(
     ...
     virtual Steinberg::TPtrInt handleReaperEmbedMessage(
	    int msg, Steinberg::TPtrInt parm2, Steinberg::TPtrInt parm3) = 0;
#endif
    //==============================================================================
